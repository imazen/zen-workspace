...
declare -A REPOS=(
  ...
  [zentiff]="$ZEN_ROOT/zenextras/zentiff/fuzz"
  ...
  [zencodecs]="$ZEN_ROOT/zenpipe/zencodecs/fuzz"
  [zenpdf]="$ZEN_ROOT/zenextras/zenpdf/fuzz"
  [zenjp2]="$ZEN_ROOT/zenextras/zenjp2/fuzz"
  [zenraw]="$ZEN_ROOT/zenraw/fuzz"
  [weezl]="$ZEN_ROOT/zenlzw/fuzz"
  [zenbitmaps]="$ZEN_ROOT/zenbitmaps/fuzz"
  [zensvg]="$ZEN_ROOT/zenextras/zensvg/fuzz"
